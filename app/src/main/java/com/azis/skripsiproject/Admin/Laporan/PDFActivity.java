...
public class PDFActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("https://docs.google.com/gview?embedded=true&url=" + AdmLaporanActivity.list.get(position).getPdfUrl());
        GET = "https://docs.google.com/gview?embedded=true&url="+AdmLaporanActivity.list.get(position).getPdfUrl();
        NAME = AdmLaporanActivity.list.get(position).getPdfName();
        txtUrl.setText(GET);
                ...
                if (title.equals("Penggunaan_Barang")){
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            startActivity(new Intent(PDFActivity.this, AdmLaporanActivity.class));
