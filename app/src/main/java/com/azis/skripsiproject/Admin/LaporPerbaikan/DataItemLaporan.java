...
public class DataItemLaporan {

    private String id, no_inventaris, jenis, tipe, tanggal, pengguna, pokja;

    public DataItemLaporan() {
    }

    public DataItemLaporan(String id, String no_inventaris, String jenis, String tipe, String tanggal, String pengguna, String pokja) {
        this.id = id;
